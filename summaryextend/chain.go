...
func (c chainClients) RevertSummarize(ownerID string, amount decimal.Decimal, extendValue ...decimal.Decimal) error {
	var (
		err, singleErr error
	)

	for _, client := range c {
		if singleErr = client.Summarize(ownerID, amount, extendValue...); singleErr != nil {
